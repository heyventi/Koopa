...
namespace kp {
	...
	void EditorLayer::OnAttach()
	{
		...
		kp::FramebufferSpecification fbSpec;
		fbSpec.Width = 1280;
		fbSpec.Height = 720;
	...
	void EditorLayer::OnUpdate(kp::Timestep ts)
	{
		KP_PROFILE_FUNCTION();

		if (kp::FramebufferSpecification spec = m_Framebuffer->GetSpecification();
...

		{
			...
			kp::Renderer2D::DrawQuad({ 0.0f, 0.0f, -0.1f }, { 20.0f, 20.0f }, m_CheckerboardTexture, 10.0f);
	...
	void EditorLayer::OnEvent(kp::Event& e)
	{
