...
TinyDefense2D::TinyDefense2D()
    : Layer("TinyDefense2D"), m_CameraController(1280.0f / 720.0f), m_SquareColor({ 0.2f, 0.3f, 0.8f, 1.0f })
{
}

void TinyDefense2D::OnAttach()
{
...
void TinyDefense2D::OnDetach()
{
}

void TinyDefense2D::OnUpdate(kp::Timestep ts)
{
    // Update
    KP_PROFILE_FUNCTION();
    {
...
void TinyDefense2D::OnImGuiRender()
{
    KP_PROFILE_FUNCTION();
...
void TinyDefense2D::OnEvent(kp::Event& e)
{
